...
function LoginForm() {
  ...
  // Si ya está autenticado, mostrar mensaje pero NO redirigir automáticamente
  useEffect(() => {
    if (isAuthenticated && !isLoading) {
      toast('Ya tienes una sesión activa. Si deseas cambiar de usuario, primero cierra sesión.', {
        icon: 'ℹ️',
        duration: 5000,
      });
    }
